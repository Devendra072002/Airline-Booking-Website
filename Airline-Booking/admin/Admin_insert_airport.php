...
<head>
    ...
    <title>Admin Insert Airport</title>
</head>
<style>
    .container{
        width: 50%;
...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="save-insert-airport.php" method="POST">
            <div class="mb-3 ">
                <label for="airid" class="form-label">Airport Id</label>
                <input type="text" class="form-control" id="airid" name="airid" required>
            </div>
            <div class=" mb-3">
                <label for="airname" class="form-label">Airport Name</label>
